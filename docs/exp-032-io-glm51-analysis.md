...
출처: 본 EXP 데이터 + `docs/exp-031-react-glm51-analysis.md`. io 는 react 의 도구/파싱 계열 이슈가 전무하나, **승률은 react(76.7%)·minimax(80.0%) 에 크게 미달**한다. io 의 파싱 안정성은 장점이지만 알고리즘 한계(2.2절)가 더 크다.
