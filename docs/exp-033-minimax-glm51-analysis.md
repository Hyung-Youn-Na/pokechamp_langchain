...
출처: 본 EXP 데이터 + `docs/exp-032-io-glm51-analysis.md` + `docs/exp-031-react-glm51-analysis.md`. minimax 는 io·react 의 의사결정 계열 약점을 해결하고 최고 승률(80%)을 기록했으나, 팀/리드 선택 계열 한계는 미해결로 남았다.
